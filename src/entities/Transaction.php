...
class Transaction extends AbstractEntity implements Entity
{
    ...
    /**
     * Документ, который инициировал создании операции. Один документ может быть инициатором множества операций:
     * пара операций при переводе от пользователя к пользователю, множества операций при массовом выводе средств и т.п.
     *
     * @var Document
     */
    private $document;
